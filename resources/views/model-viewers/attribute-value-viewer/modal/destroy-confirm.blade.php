    ...
    <div class="modal-dialog modal-md">
        ...
        {{ Form::open([ 'id' => $component->getDomId('destroy-confirmation'), 'url' => $component->getController()->getRoute('destroy', $component->getModel()) ]) }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger pull-right" data-ajax-submit-form="{{ $component->getDomIdHash('destroy-confirmation') }}"><i class="fa fa-trash-o margin-right-10"></i>{{ $component->translate('button.delete') }}</button>
            </div>
        {{ Form::close() }}
        </div>
    </div>
