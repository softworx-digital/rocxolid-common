    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ajax-overlay">
            ...
            <div class="modal-body">
                <iframe src="http://maps.google.com/maps?q={{ $component->getModel()->latitude }},{{ $component->getModel()->longitude }}&hl={{ $user->profile->language->iso_639_1 }}&z=14&amp;output=embed" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" class="mapa"></iframe>
            </div>
